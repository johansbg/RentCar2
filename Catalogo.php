                    ...
                    <div class="product-show-option">
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-md-5 text-right">
                                <p>Muestra 01-09 de 36 Productos</p>
                            </div>
                        </div>
                    </div>
                    <div class="product-list">
                        <div class="row">
                            <div id="resVehiculos" class="col-lg-4 col-sm-6">
                                <script type="module" src="../requests/Vehiculos.js"></script>
                            </div>
                        </div>
                    </div>
                </div>
